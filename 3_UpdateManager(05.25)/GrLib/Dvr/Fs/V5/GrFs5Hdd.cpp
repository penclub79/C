...
//--------------------------------------------------------------------
BOOL8	Cls_GrFs5Hdd::LcSmartFindRawQword(__u8 A_Id, __u64* A_PtrRtVal)
{
	// local -------------------
		BOOL8	Tv_Result;
		__u32	Tv_WkIdx;
	...
	// code --------------------
		...
		for(Tv_WkIdx=0; Tv_WkIdx < E_GrFs5HddSmartValCnt; Tv_WkIdx++)
		{
			if(A_Id == m_SmartIoc.Data.Values[Tv_BytePos + E_GrFs5HddSmartValIdxId])
			{
				...
				Tv_PtrTg[2]	=	m_SmartIoc.Data.Values[Tv_BytePos + E_GrFs5HddSmartValIdxRawVal + 2];
				Tv_PtrTg[3]	=	m_SmartIoc.Data.Values[Tv_BytePos + E_GrFs5HddSmartValIdxRawVal + 3];
				Tv_PtrTg[4]	=	m_SmartIoc.Data.Values[Tv_BytePos + E_GrFs5HddSmartValIdxRawVal + 4];
				Tv_PtrTg[5]	=	m_SmartIoc.Data.Values[Tv_BytePos + E_GrFs5HddSmartValIdxRawVal + 5];
				Tv_PtrTg[6]	=	m_SmartIoc.Data.Values[Tv_BytePos + E_GrFs5HddSmartValIdxRawVal + 6];
				Tv_PtrTg[7]	=	m_SmartIoc.Data.Values[Tv_BytePos + E_GrFs5HddSmartValIdxRawVal + 7];
...
BOOL8	Cls_GrFs5Hdd::SmartRead(Ptr_GrFs5Smart A_PtrRtData)
{
	...
	// code --------------------
		...
		if(LcSmartRead())
		{
			...
			LcSmartFindRawQword(E_GrFs5HddSmartIdSeekErrRate, &Tv_Val64);
			...
			LcSmartFindRawDword(E_GrFs5HddSmartIdReallocate, &A_PtrRtData->Reallocate);
			LcSmartFindRawDword(E_GrFs5HddSmartIdBadSect, &A_PtrRtData->BadSect);
			LcSmartFindRawDword(E_GrFs5HddSmartIdReadErrRate, &A_PtrRtData->ReadErr);
			Tv_Result		=	TRUE;
		}
