...
#include	<Hw/Saa7121/GrHwSaa7121.h>
...
//====================================================================
Cls_GrHwSaa7121::Cls_GrHwSaa7121( __u8 A_I2cCh, __u32 A_Adr )
{
		m_I2cCh			=	A_I2cCh;
		m_Adr				=	(__u8)A_Adr;
...
//--------------------------------------------------------------------
Cls_GrHwSaa7121::~Cls_GrHwSaa7121()
{
}
//--------------------------------------------------------------------
void		Cls_GrHwSaa7121::WriteReg( __u8 A_RegAdr, __u8 A_RegVal )
{
		GrI2cStdWrite( m_I2cCh, m_Adr, A_RegAdr, &A_RegVal, 1 );
}
//--------------------------------------------------------------------
void		Cls_GrHwSaa7121::SetSigType( __u32 A_IsPal )
{
	// local -------------------
		__u8*		Tv_PtrTbl;
		__u8		Tv_Adr;
	...
	// code --------------------
		//page1
		Tv_PtrTbl		=	V_GrHwSaa7128RtNtsc;
		if ( A_IsPal )
		{
			Tv_PtrTbl		=	V_GrHwSaa7128RtPal;
		}
...
//--------------------------------------------------------------------
BOOL8		Cls_GrHwSaa7121::IsSigPal( void )
{
		return	m_IsSigPal;
}
//--------------------------------------------------------------------
