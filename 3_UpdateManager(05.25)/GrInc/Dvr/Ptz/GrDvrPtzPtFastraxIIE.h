...
#ifndef	_EPC_GrDvrPtzPtFastraxIIE
#define	_EPC_GrDvrPtzPtFastraxIIE
...
class	Cls_GrDvrPtzPtFastraxIIE	:	public	Cls_GrDvrPtzPtBase
{
	protected:
		void	LcSendPkt( __u8 A_Cmd, __u8 A_Data1, __u8 A_Data2 );
		__u8	LcCvtPanTiltSpeed( __u8 A_Spd );
		__u8	LcCvtZoomSpeed( __u8 A_Spd );

	public:
    Cls_GrDvrPtzPtFastraxIIE( __u8 A_UartCh, __u8 A_Id, __u8 A_Ch );
    virtual		~Cls_GrDvrPtzPtFastraxIIE();
