...
#ifndef	_EPC_GrDvrPtzPtDmax
#define	_EPC_GrDvrPtzPtDmax
...
class	Cls_GrDvrPtzPtDmax	:	public	Cls_GrDvrPtzPtBase
{
	private:
	...
	public:
    Cls_GrDvrPtzPtDmax( __u8 A_UartCh, __u8 A_Id, __u8 A_Ch );
    virtual		~Cls_GrDvrPtzPtDmax();
