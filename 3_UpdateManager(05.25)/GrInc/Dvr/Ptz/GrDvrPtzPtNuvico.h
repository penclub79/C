/*
	dvr ptz protocol nuvico ez

*/

//--------------------------------------------------------------------
//Enviroment conditional
#ifndef	_EPC_GrDvrPtzPtNuvico
#define	_EPC_GrDvrPtzPtNuvico
...
class	Cls_GrDvrPtzPtNuvico	:	public	Cls_GrDvrPtzPtBase
{
	private:
	...
	public:
    Cls_GrDvrPtzPtNuvico( __u8 A_UartCh, __u8 A_Id, __u8 A_Ch );
    virtual		~Cls_GrDvrPtzPtNuvico();
