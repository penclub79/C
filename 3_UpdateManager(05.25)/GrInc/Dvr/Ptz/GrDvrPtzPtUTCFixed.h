...
#ifndef	_EPC_GrDvrPtzPtUTCFixed
#define	_EPC_GrDvrPtzPtUTCFixed
...
class	Cls_GrDvrPtzPtUTCFixed	:	public	Cls_GrDvrPtzPtBase
{
	private:
	...
	public:
    Cls_GrDvrPtzPtUTCFixed( __u8 A_UartCh, __u8 A_Id, __u8 A_Ch );
    virtual		~Cls_GrDvrPtzPtUTCFixed();
