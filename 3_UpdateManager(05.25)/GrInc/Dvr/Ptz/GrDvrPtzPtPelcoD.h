...
#ifndef	_EPC_GrDvrPtzPtPelcoD
#define	_EPC_GrDvrPtzPtPelcoD
...
class	Cls_GrDvrPtzPtPelcoD	:	public	Cls_GrDvrPtzPtBase
{
	private:
	...
	public:
    Cls_GrDvrPtzPtPelcoD( __u8 A_UartCh, __u8 A_Id, __u8 A_Ch );
    virtual		~Cls_GrDvrPtzPtPelcoD();
