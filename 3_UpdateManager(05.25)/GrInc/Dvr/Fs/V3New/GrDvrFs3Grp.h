...
#define E_GrDvrFs3GrpGthBufDwCnt			(E_GrDvrFs3GrpGthBufSize >> 2)
...
class	Cls_GrDvrFs3Grp
{
	private:
		...
		St_GrDvrFs3GrpChInfo	m_ChTbl[E_GrDvrMaxChCnt];

		__u32	m_GthBuf[E_GrDvrFs3GrpGthBufDwCnt];	// write buffer
