...
class	Cls_GrDvrFs3Disk
{
	...
	protected:
		...
		BOOL8	LcIovWrite( struct iovec* A_PtrIov, __s32 A_IovCnt, __u32 A_TotSize );
		void	LcFlush( void );
		...
		BOOL8	LcBlockWrite( __u32 A_BlkId, __u32 A_Ofs, struct iovec* A_PtrIov, __s32 A_IovCnt, __u32 A_TotSize, BOOL8 A_IsLhndlUpdt );
    ...
    virtual		~Cls_GrDvrFs3Disk();
		...
		BOOL8	BlockDataAdd( __u32 A_BlkId, __u32 A_RecId, struct iovec* A_PtrIov, __s32 A_IovCnt, __u32 A_TotSize, Ptr_GrDvrFs3BlkAddInfo A_PtrInfo, BOOL8 A_IsBdtUpdt );
