...
//--------------------------------------------------------------------
#ifndef	_EPC_GrP3DoSpinQuadStp
#define	_EPC_GrP3DoSpinQuadStp
...
#define E_GrP3DoSpinQuadStpStatDisable	0
#define E_GrP3DoSpinQuadStpStatNormal		1
#define E_GrP3DoSpinQuadStpStatFocus		2
#define E_GrP3DoSpinQuadStpStatControl	3

#define E_GrP3DoSpinQuadStpStatCnt			4
...
//====================================================================
//global type
typedef	struct	St_GrP3DoSpinQuadStpPara
{
	__u16	PntStat[E_GrP3DoSpinQuadStpStatCnt];					// paint status
...
}	*Ptr_GrP3DoSpinQuadStpPara;

//====================================================================
//global class
class	Cls_GrP3DoSpinQuadStp	:	public	Cls_GrP3DoBase
{
	protected:
		St_GrP3DoSpinQuadStpPara	m_ParaSpinQuadStp;
	...
	public:
		Cls_GrP3DoSpinQuadStp( __u16 A_ScptId, Ptr_GrRect A_PtrRect, Cls_GrP3DoBase* A_ObjPrnt );
		virtual	~Cls_GrP3DoSpinQuadStp( void );
