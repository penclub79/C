...
class	Cls_GrDvrFs3Mng	:	public	Cls_GrTaskCli
{
	private:
		...
		__u16	m_RecOwnerMain;
		__u16	m_RecOwnerMirr;
		__u16	m_RecBufThrdId;
	...
	public:
    Cls_GrDvrFs3Mng( Cls_GrTaskSvr* A_TaskSvr, __u64 A_DvrId, __u32 A_AdoUnitSize, 
    ...
    virtual		~Cls_GrDvrFs3Mng();
		...
		BOOL8	StreamAdd( __u8 A_Ch, __u8 A_Type, __u8 A_Evt, __u8 A_Res, __u8 A_SkipCnt, __u8 A_SeqId, 
			...
			);		// video packet add - thread not safe
