/*
	dvr ptz protocol pelco-d

*/

//--------------------------------------------------------------------
//Enviroment conditional
#ifndef	_EPC_GrDvrPtzPtUTCPelcoD
#define	_EPC_GrDvrPtzPtUTCPelcoD
...
class	Cls_GrDvrPtzPtUTCPelcoD	:	public	Cls_GrDvrPtzPtBase
{
	private:
	...
	public:
    Cls_GrDvrPtzPtUTCPelcoD( __u8 A_UartCh, __u8 A_Id, __u8 A_Ch );
    virtual		~Cls_GrDvrPtzPtUTCPelcoD();
