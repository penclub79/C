...
#ifdef GR_OSD_EDIT
	__u8	V_GrUiDoMosaicGridTestVal[4][32];		//test value
#endif

//====================================================================
//--------------------------------------------------------------------
Cls_GrUiDoMosaicGrid::Cls_GrUiDoMosaicGrid( Ptr_GrRect A_PtrRect, Cls_GrUiDoBase* A_ObjPrnt, BOOL8 A_IsIdAlloc ):
Cls_GrUiDoSkin( A_PtrRect, A_ObjPrnt, E_GrUiConIdxFocused, A_IsIdAlloc )
{
	// local -------------------
	// code --------------------
		//init
		m_TypeId			=	E_GrUiDoTypeIdMosaicGrid;
		m_IsFocusAble	=	TRUE;

		m_CelSizeX		=	E_GrUiDoMosaicGridDfltCellSizeX;
		m_CelSizeY		=	E_GrUiDoMosaicGridDfltCellSizeY;
		m_GridCntX		=	E_GrUiDoMosaicGridDfltGridCntX;
		m_GridCntY		=	E_GrUiDoMosaicGridDfltGridCntY;
		m_GridWidth		=	E_GrUiDoMosaicGridDfltGridWidth;
		m_ClrGrid			=	m_ObjConsole->ClrWhiteGet();

		m_ClrMark			=	m_ObjConsole->ClrBlackGet();
		m_MarkWidth		=	E_GrUiDoMosaicGridDfltMarkWidth;

		m_ClrCus			=	m_ObjConsole->ClrWhiteGet();
		m_CusWidth		=	E_GrUiDoMosaicGridDfltCusWidth;
...
#ifdef GR_OSD_EDIT
		m_PtrValBuf	=	(void*)V_GrUiDoMosaicGridTestVal;
		m_ValPitch	=	4;
		m_PtrDispBuf	=	(void*)V_GrUiDoMosaicGridTestVal;
#else
		m_PtrValBuf	=	NULL;
		m_ValPitch	=	0;
		m_PtrDispBuf	=	NULL;
...
//--------------------------------------------------------------------
Cls_GrUiDoMosaicGrid::~Cls_GrUiDoMosaicGrid()
{
}
//--------------------------------------------------------------------
void	Cls_GrUiDoMosaicGrid::LcDrawGrid( void )
{
	// local -------------------
		__u32	Tv_Idx;
		St_GrRect	Tv_Rc;
...
//--------------------------------------------------------------------
void	Cls_GrUiDoMosaicGrid::LcDrawItems( void )
{
	// local -------------------
		__s32		Tv_WkX;
		__s32		Tv_WkY;
...
//--------------------------------------------------------------------
void	Cls_GrUiDoMosaicGrid::LcDrawDisp( void )
{
	// local -------------------
		__s32		Tv_WkX;
		__s32		Tv_WkY;
...
//--------------------------------------------------------------------
void	Cls_GrUiDoMosaicGrid::LcDrawCus( void )
{
	// local -------------------
		__u32	Tv_StX;
		__u32	Tv_StY;
...
//--------------------------------------------------------------------
void	Cls_GrUiDoMosaicGrid::ProcBgSkinTblDraw( void )
{
		//inherited
...
//--------------------------------------------------------------------
__u8	Cls_GrUiDoMosaicGrid::CellXsizeGet( void )
{
		return	m_CelSizeX;
}
//--------------------------------------------------------------------
void	Cls_GrUiDoMosaicGrid::CellXsizeSet( __u8 A_Size )
{
		if ( 0 != A_Size )
		{
			m_CelSizeX	=	A_Size;
...
//--------------------------------------------------------------------
__u8	Cls_GrUiDoMosaicGrid::CellYsizeGet( void )
{
		return	m_CelSizeY;
}
//--------------------------------------------------------------------
void	Cls_GrUiDoMosaicGrid::CellYsizeSet( __u8 A_Size )
{
		if ( 0 != A_Size )
		{
			m_CelSizeY	=	A_Size;
...
//--------------------------------------------------------------------
__u8	Cls_GrUiDoMosaicGrid::GridXcountGet( void )
{
		return	m_GridCntX;
}
//--------------------------------------------------------------------
void	Cls_GrUiDoMosaicGrid::GridXcountSet( __u8 A_Cnt )
{
		if ( 0 != A_Cnt )
		{
			m_GridCntX	=	A_Cnt;
...
//--------------------------------------------------------------------
__u8	Cls_GrUiDoMosaicGrid::GridYcountGet( void )
{
		return	m_GridCntY;
}
//--------------------------------------------------------------------
void	Cls_GrUiDoMosaicGrid::GridYcountSet( __u8 A_Cnt )
{
		if ( 0 != A_Cnt )
		{
			m_GridCntY	=	A_Cnt;
...
//--------------------------------------------------------------------
__u8	Cls_GrUiDoMosaicGrid::GridWidthGet( void )
{
		return	m_GridWidth;
}
//--------------------------------------------------------------------
void	Cls_GrUiDoMosaicGrid::GridWidthSet( __u8 A_Size )
{
		m_GridWidth	=	A_Size;
		ReqDraw();
}
//--------------------------------------------------------------------
__u32	Cls_GrUiDoMosaicGrid::GridColorGet( void )
{
		return	m_ClrGrid;
}
//--------------------------------------------------------------------
void	Cls_GrUiDoMosaicGrid::GridColorSet( __u32 A_Color )
{
		m_ClrGrid	=	A_Color;
		ReqDraw();
}
//--------------------------------------------------------------------
__u8	Cls_GrUiDoMosaicGrid::MarkWidthGet( void )
{
		return	m_MarkWidth;
}
//--------------------------------------------------------------------
void	Cls_GrUiDoMosaicGrid::MarkWidthSet( __u8 A_Width )
{
		if ( 0 != A_Width )
		{
			m_MarkWidth	=	A_Width;
...
//--------------------------------------------------------------------
__u32	Cls_GrUiDoMosaicGrid::MarkColorGet( void )
{
		return	m_ClrMark;
}
//--------------------------------------------------------------------
void	Cls_GrUiDoMosaicGrid::MarkColorSet( __u32 A_Color )
{
		m_ClrMark	=	A_Color;
		ReqDraw();
}
//--------------------------------------------------------------------
__u8	Cls_GrUiDoMosaicGrid::CursorWidthGet( void )
{
		return	m_CusWidth;
}
//--------------------------------------------------------------------
void	Cls_GrUiDoMosaicGrid::CursorWidthSet( __u8 A_Width )
{
		m_CusWidth	=	A_Width;
		ReqDraw();
}
//--------------------------------------------------------------------
__u32	Cls_GrUiDoMosaicGrid::CursorColorGet( void )
{
		return	m_ClrCus;
}
//--------------------------------------------------------------------
void	Cls_GrUiDoMosaicGrid::CursorColorSet( __u32 A_Color )
{
		m_ClrCus	=	A_Color;
		ReqDraw();
}
//--------------------------------------------------------------------
void	Cls_GrUiDoMosaicGrid::ValueBufferSet( void* A_PtrBuf, __u32 A_Pitch )
{
...
//--------------------------------------------------------------------
void	Cls_GrUiDoMosaicGrid::DisplayBufferSet( void* A_PtrBuf )
{
		m_PtrDispBuf	=	A_PtrBuf;
		ReqDraw();
}
//--------------------------------------------------------------------
void	Cls_GrUiDoMosaicGrid::CursorAreaGet( Ptr_GrByteRect A_PtrRtRc )
{
...
//--------------------------------------------------------------------
void	Cls_GrUiDoMosaicGrid::LcReqDrawCus( void )
{
	// local -------------------
		__s32		Tv_StX;
		__s32		Tv_StY;
...
//--------------------------------------------------------------------
void	Cls_GrUiDoMosaicGrid::CursorPosSet( __u8 A_X, __u8 A_Y )
{
		//check able position
...
//--------------------------------------------------------------------
void	Cls_GrUiDoMosaicGrid::CursorTailSet( __u8 A_X, __u8 A_Y )
{
	// local -------------------
		__u8	Tv_X;
		__u8	Tv_Y;
...
//--------------------------------------------------------------------
BOOL8	Cls_GrUiDoMosaicGrid::ProcEvtKeyDown( __u8 A_Key )
{
	// local -------------------
		BOOL8	Tv_Result;
	// code --------------------
...
//--------------------------------------------------------------------
void	Cls_GrUiDoMosaicGrid::ValueChageOnCus( void )
{
	// local -------------------
		__u32	Tv_StX;
		__u32	Tv_StY;
...
//--------------------------------------------------------------------
void	Cls_GrUiDoMosaicGrid::ValueSetOnCus( void )
{
	// local -------------------
		__u32	Tv_StX;
		__u32	Tv_StY;
...
//--------------------------------------------------------------------
void	Cls_GrUiDoMosaicGrid::ValueResetOnCus( void )
{
	// local -------------------
		__u32	Tv_StX;
		__u32	Tv_StY;
...
//--------------------------------------------------------------------
void	Cls_GrUiDoMosaicGrid::ValueSetAll( void )
{
	// local -------------------
		__u32	Tv_BitCnt;
		__u32	Tv_ByteCnt;
...
//--------------------------------------------------------------------
void	Cls_GrUiDoMosaicGrid::ValueResetAll( void )
{
	// local -------------------
		__u32	Tv_BitCnt;
		__u32	Tv_ByteCnt;
...
//--------------------------------------------------------------------
BOOL8	Cls_GrUiDoMosaicGrid::ProcEvtMseLbtnDown( __u16 A_X, __u16 A_Y, __u8 A_BtnMap )
{
	// local -------------------
		BOOL8	Tv_Result;
		__u8	Tv_X;
...
//--------------------------------------------------------------------
BOOL8	Cls_GrUiDoMosaicGrid::ProcEvtMseMove( __u16 A_X, __u16 A_Y, __u8 A_BtnMap )
{
	// local -------------------
		BOOL8	Tv_Result;
		__u8	Tv_X;
...
//--------------------------------------------------------------------
BOOL8	Cls_GrUiDoMosaicGrid::ProcEvtMseLbtnUp( __u16 A_X, __u16 A_Y, __u8 A_BtnMap )
{
	// local -------------------
		BOOL8	Tv_Result;
		__u8	Tv_X;
...
//--------------------------------------------------------------------
void	Cls_GrUiDoMosaicGrid::ProcEvtMseLeave( void )
{
...
//--------------------------------------------------------------------
void	Cls_GrUiDoMosaicGrid::LcNotifyEvtCusChg( void )
{
	// local -------------------
	...
	// code --------------------
		...
		{
			Tv_Msg.Hd.Cmd			=	E_GrUiMsgCmdMosaicGridCusChg;
...
//--------------------------------------------------------------------
void	Cls_GrUiDoMosaicGrid::LcNotifyEvtValChg( void )
{
	// local -------------------
		St_GrUiMsgCtrl	Tv_Msg;
	// code --------------------
		if ( V_GrUiMngObj->IsUserEventOn() )
		{
			Tv_Msg.Hd.Cmd			=	E_GrUiMsgCmdMosaicGridValChg;
			Tv_Msg.Hd.ConIdx	=	E_GrUiConIdxFocused;
			Tv_Msg.Hd.WinId		=	((Cls_GrUiDoWin*)m_ObjWin)->WinIdGet();
			Tv_Msg.Hd.ObjId		=	E_GrUiObjIdNone;
			Tv_Msg.Obj				=	(void*)this;
...
//--------------------------------------------------------------------
__u32	Cls_GrUiDoMosaicGrid::DisplayColorGet( void )
{
		return	m_ClrDisp;
}
//--------------------------------------------------------------------
void	Cls_GrUiDoMosaicGrid::DisplayColorSet( __u32 A_Color )
{
		m_ClrDisp	=	A_Color;
		ReqDraw();
}
//--------------------------------------------------------------------
BOOL8	Cls_GrUiDoMosaicGrid::ProcEvtKeyUp( __u8 A_Key )
{
	// local -------------------
		BOOL8	Tv_Result;
	// code --------------------
