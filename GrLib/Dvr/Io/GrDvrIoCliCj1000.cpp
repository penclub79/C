...
//====================================================================
//local const
#define E_GrDvrioCliCj1000DirKeyIntv	2
...
//--------------------------------------------------------------------
Cls_GrDvrIoCliCj1000::Cls_GrDvrIoCliCj1000( __u8 A_UartCh, __u8 A_Id ):
...
//--------------------------------------------------------------------
Cls_GrDvrIoCliCj1000::~Cls_GrDvrIoCliCj1000()
{

}
//--------------------------------------------------------------------
BOOL8	Cls_GrDvrIoCliCj1000::RtlProc( void )
{
	// local -------------------
		BOOL8	Tv_Result;
		__u8*	Tv_PtrRecv;
...
//--------------------------------------------------------------------
void	Cls_GrDvrIoCliCj1000::LcParsPrtc( void )
{
	// local -------------------
		__u8	Tv_ChkSum;
		__u32	Tv_PlaySpd;
						...
						else
						{
							...
							if ( 0 == m_DirKeyIntv )
							{
								...
								if ( E_GrUiKeyNone != Tv_Key )
								{
									...
									m_DirKeyIntv	=	E_GrDvrioCliCj1000DirKeyIntv;
								}
							}
						}
					}
...
//--------------------------------------------------------------------
void	Cls_GrDvrIoCliCj1000::LcProcQuadKey( __u8 A_Num )
{
	// local -------------------
	// code --------------------
		//change quad
...
//--------------------------------------------------------------------
void	Cls_GrDvrIoCliCj1000::RtlTimer( void )
{
	// local -------------------
	// code --------------------
		if ( 0 != m_DirKeyIntv )
