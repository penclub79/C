...
// MFC12_3_BitMapExView.cpp : CMFC12_3_BitMapExView 클래스의 구현
//
...
CMFC12_3_BitMapExDoc* CMFC12_3_BitMapExView::GetDocument() const // 디버그되지 않은 버전은 인라인으로 지정됩니다.
{
