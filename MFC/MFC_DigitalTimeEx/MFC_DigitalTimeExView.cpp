...
// MFC_DigitalTimeExView.cpp : CMFC_DigitalTimeExView 클래스의 구현
//
...
CMFC_DigitalTimeExDoc* CMFC_DigitalTimeExView::GetDocument() const // 디버그되지 않은 버전은 인라인으로 지정됩니다.
{
