========================================================================
    MFC 라이브러리 : RootDll 프로젝트 개요
========================================================================


응용 프로그램 마법사에서 이 RootDll DLL을 만들었습니다. 이 DLL은 MFC의 기본 사용법을 보여 줄 뿐만 아니라 DLL을 작성하기 위한 기본 구조를 제공합니다.

이 파일에는 RootDll DLL을 구성하는 각 파일에 대한 요약 설명이 포함되어 있습니다.
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더(PCH) 파일 RootDll.pch와 미리 컴파일된 형식(PCT) 파일 StdAfx.obj를 빌드하는 데 사용됩니다.
